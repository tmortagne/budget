...
@Component("lcl.pdf")
public class LCLPDFTransactionReaderFactory extends AbstractTransactionReaderFactory
{
    public LCLPDFTransactionReaderFactory()
    {
        super("lcl.pdf", "LCL PDF", "LCL PDF based \"RELEVE DE COMPTE\"");
    }
